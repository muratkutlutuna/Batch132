...
public class StringManipulations01 {
    public static void main(String[] args) {
        ...
        String s = "Alabama";
        //indexOf('a') will give you the index of first occurence of 'a'
        int idxA = s.indexOf('a');
        System.out.println("idxA = " + idxA);//2
        ...
        //indexOf("java"); will give you the index of the first character of the first occurrence of "java"
        int idxJava = t.indexOf("java");
        System.out.println("idxJava = " + idxJava);

        //Note: If you use "non-existing character or characters" in the indexOf () method, it will give you "-1"
        ...
        //Example 4: Type code to find the index of the last occurrence of 'earn' given String
        //           Learn Java earn money ==> 11

        String v = "Learn Java earn money";

        int idxEarn = v.lastIndexOf("earn");
        System.out.println("idxEarn = " + idxEarn);//11

        //Note: If you use "non-existing character or characters" in the lastIndexOf () method, it will give you "-1"
        //Note 2: lastIndexOf() method can be used with "char" and "String" data types

        //Example 5: Type code to check if a given charcter is unique or not in a given String
