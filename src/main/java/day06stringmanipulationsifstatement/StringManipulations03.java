...
public class StringManipulations03 {
    public static void main(String[] args) {
        ...
        //           java is java, I like java ==> python is java, Ilike java
        String t = "java is java, I like java";

        String updatedT = t.replaceFirst("java", "python");

        System.out.println("updatedT = " + updatedT);//python is java, I like java
        ...
        //1.Way:
        String u1 = u + u + u + u;
        System.out.println("u1 = " + u1);//JavaJavaJavaJava

        //2.Way:
        String u2 = u.concat(u).concat(u).concat(u);
        System.out.println("u2 = " + u2);//JavaJavaJavaJava

        //3.Way:
        String u3 = u.repeat(4);
        System.out.println("u3 = " + u3);//JavaJavaJavaJava
