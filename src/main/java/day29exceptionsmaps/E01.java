...
public class E01 {
    /*
        What are the differences between "throw" and "throws" in the Exceptions
        ...
        4)After "throw" you can throw just a single Exception, after "throws" you can throw multiple Exception
        ...
        1)Java created its own Exception Classes for common issues like dividing by zero, using non-existing indexes etc.
          ...
          To create out own strict rules in our application we create our own Exception Classes.
