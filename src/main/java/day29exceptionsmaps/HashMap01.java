...
public class HashMap01 {
    ...
    /*
        ...
        5)Maps are in 3 types i)HashMap:
                              ...
                              ii)HashTable
                              iii)TreeMap
        6)If you use the same key repeatedly in a Map, final value will be accepted in the Map.
    ...
    public static void main(String[] args) {
        ...
        cp.put("Albania", 3000000);
        System.out.println(cp);//{null=45000000, USA=400000000, Democratic Kongo=null, Nicaragua=null, Germany=83000000, Albania=3000000}
        ...
        System.out.println(values);//[45000000, 400000000, null, null, 83000000, 3000000]
        int total = 0;
        ...
        System.out.println(total);//531.000.000
        ...
        System.out.println(cp);//{null=45000000, USA=410000000, Democratic Kongo=null, Nicaragua=null, Germany=83000000, Albania=3000000}

        cp.replace("USA", 410000000, 390000000);
        System.out.println(cp);//{null=45000000, USA=390000000, Democratic Kongo=null, Nicaragua=null, Germany=83000000, Albania=3000000}

        int numOfEntries = cp.size();//size() methods returns num of entries
        System.out.println(numOfEntries);//6

        Integer r1 = cp.getOrDefault("XYZ", 0);
        Integer r11 = cp.getOrDefault("USA", 0);
        System.out.println(r1);//0
        System.out.println(r11);//390000000

        cp.putIfAbsent("USA", 500000000);//putIfAbsent() method puts the entry into the map if the kay is absent
        System.out.println(cp);//{null=45000000, USA=390000000, Democratic Kongo=null, Nicaragua=null, Germany=83000000, Albania=3000000}

        cp.putIfAbsent("Belgium", 500000000);
        System.out.println(cp);//{null=45000000, USA=390000000, Democratic Kongo=null, Nicaragua=null, Belgium=500000000, Germany=83000000, Albania=3000000}
        ...
        System.out.println(allEntries);//[null=45000000, USA=390000000, Democratic Kongo=null, Nicaragua=null, Belgium=500000000, Germany=83000000, Albania=3000000]
