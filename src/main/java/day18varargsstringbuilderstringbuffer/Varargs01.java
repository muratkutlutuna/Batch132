...
public class Varargs01 {
    ...
    /*
        1)If you want to create a method works with any number with any number of parameters, remember to use "Varargs"
        2)"Varargs" is a data structure uses "Arrays" behind that is why when you use "Varargs" you may think you are using "Arrays"
        3)Question: Can I use more than one "Varargs" in a meethod?
                    No I can't. Varargs can not be made full, that is why Java cannot jump to the second parameter so second parameter will be "unreachable",
                    if you type "unreachable code" in anywhere Java will give you error.
        4)Question: Can I use another parameter after "Varargs" in a meethod?
                    No I can't. Varargs can not be made full, that is why Java cannot jump to the second parameter so second parameter will be "unreachable",
                    if you type "unreachable code" in anywhere Java will give you error.
        5)Question: Can I use parameter before "Varargs" in a meethod?
        ...
        6)"Varargs" can be declared like "int... v" or "int ...v". There is no any other usage
                    ...
                    Note: "Varargs" should be last parameter
    ...
    public static void main(String[] args) {
        ...
        int r2 = add(3, 5);
        System.out.println("r2 = " + r2);//8

        int r3 = add(3, 5, 1, 2, 10);
        System.out.println("r3 = " + r3);//21
