...
public class Honda implements Ac, Engine{
    ...
    /*
        ...
        2)To prevent huge class we can group the methods and put them in different classes but
          that needs multiple parent classes. Java does not support multiple inheritance.
        3)Multiple inheritance is not supported for classes, if you use "interface" as parents Java will
          let you crate multiple patents for class.
          As a summaru, multiple inheritance is allowed for interfaces.

        4)If you use a huge parent class, when any part is broken in the huge parent class the structure will be down.
          But if you cteate multiple small parents when any parent is broken just a small functionality will be down.
          This is preferable.
        ...
        6)Interfaces are "fully abstract", I mean Interfaces cannot concrete methods, all methods in an interface
          ...
          not to forget "mandatory functionalities" to implement for a child class, using interfaces is perfect.
        ...
        7)To make an "interface" parent of a "concrete class" use "implements" keyword instead of "extends"
          ...
          *To make a "class" parent of another "interface" is impossible.
        ...
        9)Interfaces do not have "cpnstructor" that is why you cannot create an object from an interface.
          As you remember, we cannot create an object from "abstract class" as well.
          But "abstract classes" have constructors, the constructor cannot create an object.
