...
public class StringManipulations01 {
    ...
    public static void main(String[] args) {
        ...
        //1.Way
        boolean result1 = s.charAt(6) == 'a';// There are 2 tasks for Java; equation and charAt method
        System.out.println("Is the seventh charcter a? " + result1);//true

        //2.Way
        boolean result2 = s.startsWith("a", 6);// There are 1 task for Java; startsWith method
        System.out.println("Is the seventh charcter a? " + result2);//true
        ...
        System.out.println("Is the String ending with \"money\"? "+result3);//true

        //2.Way: endswith()
        boolean result4 = t.endsWith("money");
        System.out.println("Is the String ending with \"money\"? "+result4);//true
