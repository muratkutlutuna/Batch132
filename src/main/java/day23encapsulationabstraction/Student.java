...
public class Student {
    ...
    /*
        ...
        2)After encapsulation a data, if you need you may "read" the value
        ...
        4)After encapsulation a data, if you need you may "update" the value
          by using "set method"(setter)
        5)In setters;
            i)"Access Modifier" is "public"
            ii)"Return Type" must be "void"
            iii)"Method Name" should have "set + <Variable Name>" structure
            iv)setters use "parameters", the parameter will bw the same with the variable
        6)If you want to create a "hidden", "updateable" but "not readable" variable: i) Make access modifier "private
