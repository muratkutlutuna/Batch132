...
public class Animal {
    ...
    /*
        ...
        3)The method in child class(Overriding Method) can use "same" or "wider" access modifier than the method in parent class(Overriden Method)
        ...
        7)Between the "Wrapper Classes" there is no "parent-child relationship that is why you cannot have "IS-A" relationship
          If you do not have "IS-A" relationship you cannot return type in "Method Overriding"
        ...
        11)"static" keyword cannot be overridden

            "final" keyword in Java:
            1)"final" keyword can be used for variables
              If you use "final" keyword for variables i) You have to initialize the varibale ii) After assigning a value you cannot update the value.
        ...
        What is the difference between "Method Overloading" and "Method overriding"?
            i)"Method Overloading" needs "inheritance" but "Method overriding" occurs in a single class we do not need "inheritance"
            ii)"private" methods cannot be overridden but can be overloaded
            iii)We do not touch "method signature" in "Method Overloading" but we change "parameters" I mean method signature in "Method Overloading"
