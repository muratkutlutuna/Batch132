...
/*
    ...
    4)Java executes "Coonstructors" from top to bottom in inheritance
    5)To be able to execute "Coonstructors" from top to bottom, Java goes to the "Object Class"
    ...
    10)"this()" is for calling constructor from the itself.
    11)When you type "this()", you have to type it into the first line inside the constructor.
    12)"this()" and "super()" cannot use in the same constructor together, because
       if you put anyone into the first line, the other cannot put into the first line.
