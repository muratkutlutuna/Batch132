...
public class E01 {
    ...
    /*
        1)To handle multiple Exceptions you can use "multiple catch block" or "single catch block"
        ...
        3)When you use "multiple catch blocks" the order of the catch blocks is not important if and only if
          ...
          If there id parent child relationship among them the child must be used first,.
     */
    ...
    public static int divideByNumOfChars(String s) {
        ...
        try {
            ...
            return num / (numOfChars - 1);//ArithmeticException is possible
